...
const sidebarItems = [
  ...
  { label: "Universities", icon: Building, to: "/universities", roles: ["super_admin", "admin", "center", "staff"] },
  { label: "Boards", icon: BookOpen, to: "/boards", roles: ["super_admin", "admin", "center", "staff"] },
